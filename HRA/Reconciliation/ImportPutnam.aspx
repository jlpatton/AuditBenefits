<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ImportPutnam.aspx.cs" Inherits="HRA_ImportPutnam" Title="Import Putnam Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <ul id="sitemap"> 
                ...
                <li><a>Reconciliation</a>
                    <ul id="expand1">
                        <li><a>Import</a>
		                    <ul id="expand2">
		                        <li><asp:HyperLink ID="hypPutnam" runat="server" Font-Underline="true" NavigateUrl="~/HRA/Reconciliation/ImportPutnam.aspx">Putnam</asp:HyperLink></li>
    ...
    <div id="contentright">       
	     <div id = "importbox">	     
            <fieldset>
                <legend>Import Putnam Report</legend>         

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ImportPutnamAdj.aspx.cs" Inherits="HRA_ImportPutnamAdj" Title="Import Putnam Adjustments Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                    ...
                    <ul id="expand1">
                        <li><a>Import</a>
		                    <ul id="expand2">
		                        ...
		                        <li><asp:HyperLink ID="hypPutnamAdj" runat="server" Font-Underline="true" NavigateUrl="~/HRA/Reconciliation/ImportPutnamAdj.aspx">PutnamAdj</asp:HyperLink></li>	
    ...
    <div id="contentright">       
	     <div id = "importbox">	     
            <fieldset>
                <legend>Import Putnam Adjustments Report</legend>         
                <div style="margin-top:20px;padding-left:9px;">
                    ...
                    <asp:DropDownList ID="ddlYrmo" runat="server" Width="100px" AutoPostBack="True" OnSelectedIndexChanged="ddlYRMO_selectedIndexchanged"></asp:DropDownList>
                     <div id="DivNewYRMO" runat="server" visible="false" style="background-color:#F7F7F7; display:block; width:600px; padding-bottom:10px; padding-top:10px;margin-left:-10px;">
                        ...
                        <asp:TextBox ID="txtPrevYRMO" runat="server" Width="100px" ValidationGroup="yrmoGroup" OnTextChanged="txtPrevYRMO_textChanged"></asp:TextBox>
                        <asp:Label ID="lbl_yrmofrmt" runat="server" ForeColor="#7D7D7D" Text="(yyyymm)"></asp:Label>
                        <asp:Button ID="btnCancelYrmo" runat="server"  Text="Cancel" OnClick="btn_CancelYrmo" style="margin-left:10px;margin-right:5px;" CausesValidation="false"/>
                ...
                <asp:MultiView id="MultiView1" runat="server" ActiveViewIndex="0">                                            
                    <asp:View id="view_main" runat="server">
                        <div id="upload_manually" style="padding-top:15px;" runat="server">
                            <FileUpload:FileUpload1 ID="FileUpload1" runat="server" Required="true" Vgroup="fileGroup"  FileTypeRange="xls,txt"/>                             
                            <asp:Button ID="btn_manImport" runat="server" style="margin-left:50px; margin-bottom:30px;" ValidationGroup="fileGroup" OnClientClick="document.getElementById('ctl00_ContentPlaceHolder1_HiddenField1').value = document.getElementById('ctl00_ContentPlaceHolder1_FileUpload1_FilUpl').value;" Text="Import File" OnClick="btn_manImport_Click" />                           
                        ...
                        <div id="upload_auto" style="margin-top:10px;" runat="server">
                            ...
                            <asp:Label ID="lbl_clientfile" runat="server" Width="600px" style="font-size:105%;float:left; padding-left:2px;" ForeColor="#000099" Font-Size="12px"></asp:Label>

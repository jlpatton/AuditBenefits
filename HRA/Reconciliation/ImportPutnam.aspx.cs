...
public partial class HRA_ImportPutnam : System.Web.UI.Page
{
    private const string _category = "Reconciliation";
    private const string source = "Putnam";
    int _counter = 0;
    ...
    protected void btn_manImport_Click(object sender, EventArgs e)
    {
        ...
        lbl_error.Text = "";
        string logFilePath = Server.MapPath("~/uploads/") + "Exceptions_Putnam_" + yrmo + ".txt";
    ...
    protected void lnk_genLogRpt_OnClick(object sender, EventArgs e)
    {
        lbl_error.Text = "";
        string _yrmo = ddlYrmo.SelectedItem.Text;
        string logFileName = "Exceptions_Putnam_" + _yrmo + ".txt";

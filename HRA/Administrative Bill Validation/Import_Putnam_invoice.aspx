<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Import_Putnam_invoice.aspx.cs" Inherits="HRA_Administrative_Bill_Validation_Import_Putnam_invoice" Title="Import Putnam Invoice Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="contentleft">        
            ...
            <ul id="sitemap">	
               ...
               <li><a>Admin bill validation</a>
                    <ul id="expand1">
		                <li><a>Import</a>
		                    <ul id="expand2">
		                        <li><asp:HyperLink ID="hypPtnmInv" runat="server" Font-Underline="true" NavigateUrl="~/HRA/Administrative Bill Validation/Import_Putnam_invoice.aspx">Putnam Invoice</asp:HyperLink></li>
	 ...
	 <div id="contentright">       
	     <div id = "importbox">	     
            <fieldset>
                <legend>Import Putnam Invoice Report</legend>         
                    ...
                    <asp:MultiView id="MultiView1" runat="server" ActiveViewIndex="0">                                            
                        <asp:View id="view_main" runat="server">
                            <div id="upload_manually" style="padding-top:15px;padding-left:25px;" runat="server">
                                <FileUpload:FileUpload1 ID="FileUpload1" runat="server" Required="true" Vgroup="fileGroup"  FileTypeRange="doc"/>                             
                            ...
                            <div id="upload_auto" style="margin-top:10px;padding-left:25px;" runat="server">
                        ...
                        <asp:View id="view_reimport" runat="server">                                                                                     
                            ...
                            <asp:Label ID="lbl_note" runat="server" Text="Note: <i>Clicking 'Re-Import File' deletes data for the selected Quarter-Year</i>" style="margin-bottom:15px; display:block;"></asp:Label>
                        </asp:View>

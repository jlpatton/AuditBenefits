<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="VWA_Home" Title="VWA Home Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="contentright">
        <div id = "introText">Vengroff Williams and Associates Transactions module</div>                
    </div>
</asp:Content>

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Home.aspx.cs" Inherits="DsktpHist_Home" Title="Home" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="contentleft">
        <div id="module_menu">
            ...
            <ul id="sitemap">
                <li style="left: 0px; top: 0px">
                    <asp:HyperLink ID="hypTowerGroup" runat="server" NavigateUrl="~/DsktpHist/Tower.aspx">Tower Group</asp:HyperLink>
                </li>
               <%-- <li>--%>
                   <%-- <ul id="expand1">--%>
                       <%-- <li>
        ...
        <div id="contentright">
        <div id ="introText">EBA Desktop Data Module</div> 
    </div>
</asp:Content>

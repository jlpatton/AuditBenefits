<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PCaudit.aspx.cs" Inherits="PCaudit" Title="PC Audit Trails" %>
    ...
    <div id="contentleft">
        <div id="module_menu">
            ...
            <ul id="sitemap">
                ...
                <li style="left: 0px; top: 0px">
                    <asp:HyperLink ID="HyperLink8" runat="server">PC Audit Data</asp:HyperLink>
                </li>
            </ul>
            ...
            <asp:View ID="View1" runat="server">
                <div style="margin-top: 10px;">
                    ...
                    <div id="formHra">
                        ...
                        &nbsp;--%>
                        <fieldset>
                            <legend>PC Audit Trails</legend>
                            <%--<table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblFromDt1" runat="server" Text="From Date" CssClass="labelHra"></asp:Label>
                                        <asp:TextBox ID="txtFromDt1" runat="server" CssClass="inputHra"></asp:TextBox>
                            ...
                            <asp:LinkButton ID="btnSearch" runat="server" OnClientClick="this.blur();" Font-Underline="false"
                                            CssClass="imgbutton" ValidationGroup="grp2" OnClick="btnSearch_Click"><span>Search</span></asp:LinkButton>
                            <br class="br_e" />
                            <br class="br_e" />
                            <asp:Label ID="lblFromDt" runat="server" Text="From Date:" CssClass="labelHra"></asp:Label>
                                        <asp:TextBox ID="txtFromDt" runat="server" CssClass="inputHra"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvFromDt" ValidationGroup="grp2" runat="server"
                                            ErrorMessage="From Date is required!" ControlToValidate="txtFromDt">*</asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revFromDt" ControlToValidate="txtFromDt" ValidationExpression="^(0[1-9]|1[012])[/](0[1-9]|[12][0-9]|3[01])[/]\d{4}$"
                                            runat="server" Display="Dynamic" ValidationGroup="grp2" ErrorMessage="Correct Date format is mm/dd/yyyy" />
                            <br class="br_e" />
                            <asp:Label ID="lblToDate" runat="server" Text="To Date:" CssClass="labelHra"></asp:Label>
                            <asp:TextBox ID="txtToDt" runat="server" CssClass="inputHra"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvToDt" ValidationGroup="grp2" runat="server" ErrorMessage="To Date is required!"
                                ControlToValidate="txtToDt">*</asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtToDt"
                                ValidationExpression="^(0[1-9]|1[012])[/](0[1-9]|[12][0-9]|3[01])[/]\d{4}$" runat="server"
                                Display="Dynamic" ValidationGroup="grp2" ErrorMessage="Correct Date format is mm/dd/yyyy" />
                            <br class="br_e" />
                            <br class="br_e" />
                            <asp:CompleteGridView ID="GridView1" runat="server" Width="640px" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="typecode" HeaderText="Audit Type" SortExpression="typecode"></asp:BoundField>
                                    <asp:BoundField DataField="pcname" HeaderText="PC Name" SortExpression="pcname"></asp:BoundField>
                                    <asp:BoundField DataField="userid" HeaderText="User" SortExpression="userid"></asp:BoundField>
                                    <asp:BoundField DataField="userdt" HeaderText="Date" SortExpression="userdt" DataFormatString="{0:d}">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="usertime" HeaderText="Time" SortExpression="usertime"

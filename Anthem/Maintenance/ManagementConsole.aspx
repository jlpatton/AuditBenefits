<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ManagementConsole.aspx.cs" Inherits="Anthem_Maintenance_ManagementConsole" Title="Management Console" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                    ...
                    <ul id = "expand1">
		                <li><a>Module Maintenance</a>
		                    <ul id = "expand2">
		                        ...
		                        <li><asp:HyperLink ID="hypConsole" Font-Underline="true" runat="server" NavigateUrl="~/Anthem/Maintenance/ManagementConsole.aspx">Management Console</asp:HyperLink></li>		                        
		                    </ul>
		                </li>                        
    ...
    <div id="contentright">
        <div id = "introText">Manage Anthem Module</div>                
    </div>
</asp:Content>

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Preferences.aspx.cs" Inherits="Anthem_Maintenance_Preferences" Title="Preferences" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                    ...
                    <ul id = "expand1">
                        ...
                        <li><a>Current Users</a>
                            <ul id = "expand2">
                                ...
                                <li><asp:HyperLink ID="hypPref" Font-Underline="true" runat="server" NavigateUrl="~/Anthem/Maintenance/Preferences.aspx">Preferences</asp:HyperLink></li>
                            </ul>
                        </li>		            
		            </ul>
		       </li>
    ...
    <div id="contentright">
        <div id = "introText">User Preferences</div>                
    </div>
</asp:Content>

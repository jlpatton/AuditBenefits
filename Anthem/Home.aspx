<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Anthem_Home" Title="Anthem Home Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="contentright">
        <div id = "introText">Welcome to Anthem Reconciliation</div>                
    </div>
</asp:Content>

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Import_Claims_DF_Report.aspx.cs" Inherits="Anthem_Claims_Import_Claims_Report1" Title="Import Medical Claims DF Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="contentright">
                ...
                <ul>
	                <li><a class="menuNavone" href="#">Import Reports</a>
		                ...
		                <ul>
			                ...
			                <li><a href="Import_Claims_DF_Report.aspx">Claims DF Report</a></li>
			                <li><a href="Import_DFRF_Report.aspx">DF/RF Report</a></li>
			                <li><a href="Import_DFnoRF_Report.aspx">DFnoRF Report</a></li></ul>
		                </td></tr></table>
	                </li>
	            </ul>	                            
            </div>
        ...
        <div id = "importbox">                
            <fieldset>
                <legend>Import Medical Claims DF Report</legend>         

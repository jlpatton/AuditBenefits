...
public partial class Anthem_Claims_Import_BOA_Statement : System.Web.UI.Page
{    
    int counter = 0;
    ...
    protected void checkPastImport()
    {
        ...
        lbl_error.Text = "";
        if (AnthImport.PastImport("BOA", _yrmo))
        {
    ...
    protected void MatchYRMO(string strFilePath1)
    {
        ...
        String yrmo_file = yrmoObj.matchYrmoTxt(strFilePath1, "BOA");
        if (yrmo_file == "")
        {

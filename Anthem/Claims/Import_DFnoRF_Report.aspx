<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Import_DFnoRF_Report.aspx.cs" Inherits="Anthem_Claims_Import_DF_Report1" Title="Import DF no RF Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="contentright">
                ...
                <ul>
	                <li><a class="menuNavone" href="#">Import Reports</a>
		                ...
		                <ul>
			                ...
			                <li><a href="Import_DFnoRF_Report.aspx">DFnoRF Report</a></li>
			                </ul>
		                </td></tr></table>
	                </li>
	            </ul>	                            
        ...
        <div id = "importbox">                
            <fieldset>
                <legend>Import DFnoRF Report</legend>         

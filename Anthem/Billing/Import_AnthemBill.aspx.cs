...
public partial class Anthem_Billing_Import_AnthemBill1 : System.Web.UI.Page
{   
    int counter = 0;   
    ...
    protected void checkPastImport()
    {
        ...
        lbl_error.Text = "";
        if (AnthImport.PastImport("ANTH", _yrmo))
        {
    ...
    {      
        if (Page.IsValid)
        {
            ...
            if (FileUpload1.GotFile)
            {
                ...
                {
                    ImportDAL iObj = new ImportDAL();
                    iObj.Rollback("ANTH", ddlYrmo.SelectedItem.Text);
    ...
    protected void btn_ignoreSheet_Click(object sender, EventArgs e)
    {

    }
    protected void cancel_ignoreSheet_Click(object sender, EventArgs e)
    {

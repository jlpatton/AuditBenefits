<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Reconciliation_Domestic.aspx.cs" Inherits="Anthem_Billing_Reconciliation_Domestic" Title="Domestic Reconciliation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="contentright">
	    ...
	    <div id = "importbox">	  
            <fieldset>
                <legend>Domestic Reconciliation</legend>
	    ...
	    <div id = "resultDiv" runat="server">
	        <div id = "introText">Active Reconciliation Report</div> 
	        <div style="float:left;width:650px;margin-top:20px;" >	    
	            <asp:GridView ID="grdvActResult" runat="server"  AutoGenerateColumns="False" CssClass="customGrid" PagerSettings-Mode="NumericFirstLast"
                ...
                AllowSorting="true" OnPageIndexChanging="grdvActResult_PageIndexChanging" OnSorting="grdvActResult_Sorting" >
            ...
            <div id = "introText">Retiree Reconciliation Report</div>             
	        <div style="float:left;width:650px;margin-top:20px;" >	    
	            <asp:GridView ID="grdvRetResult" runat="server"  AutoGenerateColumns="False" CssClass="customGrid" PagerSettings-Mode="NumericFirstLast"
                PagerSettings-FirstPageImageUrl="~/styles/images/firstPage.gif"
                PagerSettings-NextPageImageUrl="~/styles/images/nextPage.gif"
                PagerSettings-PreviousPageImageUrl="~/styles/images/prevPage.gif"
                PagerSettings-LastPageImageUrl="~/styles/images/lastPage.gif" AllowPaging="true" 
                AllowSorting="true" OnPageIndexChanging="grdvRetResult_PageIndexChanging" OnSorting="grdvRetResult_Sorting" >
                <PagerStyle CssClass="customGridpaging"  />
                     <Columns>
                        <asp:BoundField DataField="rcn_yrmo" HeaderText="YRMO" SortExpression="rcn_yrmo" />
                        <asp:BoundField DataField="anthcd_plancd" HeaderText="Anthem Group Suffix" SortExpression="anthcd_plancd" />
            ...
            <div style="float:left;width:650px;margin-top:20px;" >                
                <div id = "subIntroText">Cobra Reconciliation Report <asp:Button ID="btnCobDet" runat="server" style="margin-left:50px" Text="Cobra Details Report" OnClick="btnCobDet_OnClick" /></div> 
            </div>
	        <div style="float:left;width:650px;margin-top:20px;" >	    
	            <asp:GridView ID="grdvCobResult" runat="server"  AutoGenerateColumns="False" CssClass="customGrid" PagerSettings-Mode="NumericFirstLast"
                PagerSettings-FirstPageImageUrl="~/styles/images/firstPage.gif"
                PagerSettings-NextPageImageUrl="~/styles/images/nextPage.gif"
                PagerSettings-PreviousPageImageUrl="~/styles/images/prevPage.gif"
                PagerSettings-LastPageImageUrl="~/styles/images/lastPage.gif" AllowPaging="true" 
                AllowSorting="true" OnPageIndexChanging="grdvCobResult_PageIndexChanging" OnSorting="grdvCobResult_Sorting" >
                <PagerStyle CssClass="customGridpaging"  />
                     <Columns>
                        <asp:BoundField DataField="rcn_yrmo" HeaderText="YRMO" SortExpression="rcn_yrmo" />
                        <asp:BoundField DataField="anthcd_plancd" HeaderText="Anthem Group Suffix" SortExpression="anthcd_plancd" />

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Import_Retiree_NM_Headcount.aspx.cs" Inherits="Anthem_Billing_Import_Retiree_NM_Headcount1" Title="Import Retiree Non Medicare Headcount File" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="contentright">
        <div id="Navigation">
	     ...
	     <div id = "importbox">	     
            <fieldset>
                <legend>Import Retiree Medicare/Non Medicare Headcount Report</legend>         

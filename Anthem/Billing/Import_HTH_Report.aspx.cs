...
public partial class Anthem_Billing_Import_HTH_Report1 : System.Web.UI.Page
{
    int counter = 0;
    ...
    protected void checkPastImport()
    {
        ...
        lbl_error.Text = "";
        if (AnthImport.PastImport("HTH", _yrmo))
        {
    ...
    protected void btn_import_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            if (FileUpload1.GotFile)
            {
                ...
                {
                    ImportDAL iObj = new ImportDAL();
                    iObj.Rollback("HTH", ddlYrmo.SelectedItem.Text);

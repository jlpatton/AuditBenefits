<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Import_AnthemBill.aspx.cs" Inherits="Anthem_Billing_Import_AnthemBill1" Title="Import Anthem Bill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="contentleft">        
        <div id = "module_menu">
		    ...
		    <ul id="sitemap">		               	      
		        <li><a>Billing</a>
		            <ul id = "expand1">
		                <li><asp:HyperLink ID="hypBillingImp" runat="server" Font-Underline="true" NavigateUrl="~/Anthem/Billing/Imports.aspx">Import</asp:HyperLink></li><li><asp:HyperLink ID="hypBillingRecon" runat="server" NavigateUrl="~/Anthem/Billing/Reconciliation.aspx">Reconciliation</asp:HyperLink></li></ul>
		        </li>
                <li><a>Claims</a>
                     <ul>
    ...
    <div id="contentright">
            ...
            <div class="menuNav">
                <ul>
	                ...
	                <!--[if IE 7]><!--></a><!--<![endif]-->
		                <table><tr><td>
		                <ul>
			                <li><a href="Import_AnthemBill.aspx">Anthem Bill</a></li><li><a href="Import_HTH_Report.aspx">International HTH File</a></li><li><a href="Import_GRS_Active_Pilot.aspx">GRS Active Pilot HeadCounts Report</a></li><li><a href="Import_ADP_Cobra.aspx">ADP Cobra Headcounts Report</a></li><li><a href="Import_Retiree_MC_Headcount.aspx">Retiree Medicare Headcount Report</a></li><li><a href="Import_Retiree_NM_Headcount.aspx">Retiree Non-Medicare Headcount Report</a></li></ul>
		                </td></tr></table>
		                <!--[if lte IE 6]></a><![endif]-->
	                </li>
	            </ul>	                            
	    ...
	    <div id = "importbox">	    
            <fieldset>
                <legend>Import Anthem Bill Report</legend>  
                    ...
                    <asp:MultiView id="MultiView1" runat="server" ActiveViewIndex="0">                                            
                        ...
                        <asp:View id="view_ignoreSheet" runat="server">
                            <br />
                            <br />                        
                            <asp:Label ID="lbl_ignoreSheet" runat="server"></asp:Label>                        
                            <br />
                            <br />
                            <asp:Button ID="btn_ignoreSheet" runat="server" Text="Continue" OnClick="btn_ignoreSheet_Click" Width="85px" />
                             &nbsp; &nbsp;&nbsp;
                            <asp:Button ID="cancel_ignoreSheet" runat="server" Text="Cancel" OnClick="cancel_ignoreSheet_Click" Width="82px" />
                            <br />
                            <br />
